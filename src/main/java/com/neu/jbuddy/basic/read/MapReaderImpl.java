...
public class MapReaderImpl extends BasicKeywordReader implements KeywordReader {

	private final String KEY_WORD = "map";

	private final String KEY_WORD2 = "hashmap";

	private final short MAX_PROPERTY_CNT = 10;
	...
	public boolean iskeyReader(String key) {
		...
		if (KEY_WORD.equals(keywords[0].trim())
				|| KEY_WORD2.equals(keywords[0].trim())) {
			return true;
		}
		return false;
	}
